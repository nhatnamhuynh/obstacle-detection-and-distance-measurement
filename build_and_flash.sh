...
PROJECT_NAME="obstacle-detection-and-distance-measurement"
BUILD_DIR="build"
STLINK_SN="54FF72064885525637190787"
...
"$STM32_PROGRAMMER_CLI" -c port=SWD -w "$BUILD_DIR/${PROJECT_NAME}.bin" 0x08000000 -v -rst